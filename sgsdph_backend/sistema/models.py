...
class Anticipo(models.Model):
    ...
    fecha = models.DateField(auto_now_add=True)
    dias_estimadods = models.IntegerField()
    alimentacion_costo = models.DecimalField(decimal_places=2, max_digits=9)
    hospedaje_costo = models.DecimalField(decimal_places=2, max_digits=9)
    transporte_costo = models.DecimalField(decimal_places=2, max_digits=9)
    desayuno_costo = models.DecimalField(decimal_places=2,  max_digits=9)
