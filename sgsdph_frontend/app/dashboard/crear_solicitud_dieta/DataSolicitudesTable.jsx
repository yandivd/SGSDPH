...
const DataSolicitudesTable = ({solicitudes, refreshFunction, loading}) => {
    ...
    //inicialmente solicitudes y products valdran [], pues solicitudes vienen de page q inicialmente valen [].
    // hasta que de llaman, luego solicitudes toma valor pero los productos sugen valiendo [], por lo que tenegemos
    // que hacer un setProducts en el useEffect para que estas solicitudes se pongan en los productos
