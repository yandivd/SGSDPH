// Define los municipios por provincia
export const municipios = [
    ["-"],
    ["Pinar del Río", "-", "Pinar del Rio", "Consolacion del Sur", "San Juan y Martinez", "Sandino", "Los Palacios", "Guane", "La Palma", "Minas de Matahambre", "San Luis", "Vinales", "Mantua"],
    ["Artemisa", "-", "Artemisa", "Guanajay", "Caimito", "Bauta", "San Cristobal", "Candelaria", "Bahia Honda", "Mariel", "Alquizar", "Guira de Melena", "San Antonio"],
    ...
    ["Camagüey", "-", "Carlos Manuel de Céspedes", "Esmeralda", "Sierra de Cubitas", "Minas", "Nuevitas", "Guáimaro", "Sibanicú", "Camagüey", "Florida", "Vertientes", "Jimaguayú", "Najasa", "Santa Cruz del Sur"],
